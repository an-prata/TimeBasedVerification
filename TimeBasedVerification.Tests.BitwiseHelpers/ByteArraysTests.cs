...
namespace TimeBasedVerification.Tests.BitwiseHelpers
{
    public class ByteArraysTests
    {
        ...
        public void ConversionTest(ushort given, byte[] expected)
        {
            Assert.Equal(expected, ToBytes(given));
        }
        ...
        public void ConversionTest32(uint given, byte[] expected)
        {
            Assert.Equal(expected, ToBytes(given));
        }
        ...
        public void ConversionTest64(ulong given, byte[] expected)
        {
            Assert.Equal(expected, ToBytes(given));
        }
    }
